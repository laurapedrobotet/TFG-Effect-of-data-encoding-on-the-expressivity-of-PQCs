...
# FITTING FOR 1D BURGERS' EQUATION USING A PQC WITH 1 QUBIT AND LINEAR ENCODING STRATEGY
...
def main():
    ...
    save_path = f"../results_VQC_1D_LE/t{time}_{nlayers}layers_{epochs}epochs_{lr}lr_{random_seed}rng"
